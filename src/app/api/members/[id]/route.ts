...
export async function PUT(
  ...
  try {
    ...
    const {
      ...
      member_type_id, member_level_id, join_date, expire_date, status,
    } = body;
    ...
    if (member_type_id) updateData.member_type_id = member_type_id;
    if (member_level_id) updateData.member_level_id = member_level_id;
